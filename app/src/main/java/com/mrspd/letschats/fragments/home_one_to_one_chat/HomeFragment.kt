package com.mrspd.letschats.fragments.home_one_to_one_chat
...
import com.mrspd.letschats.databinding.HomeFragmentBinding
import com.mrspd.letschats.models.ChatParticipant
import com.mrspd.letschats.models.User
import com.mrspd.letschats.services.MyFirebaseMessagingService
import com.mrspd.letschats.ui.mainActivity.SharedViewModel
import com.mrspd.letschats.util.*
...
//        LoginManager.getInstance().logOut()
    ...
    private fun removeUserToken() {
        val loggedUserID = AuthUtil.getAuthId()
    ...
    private fun signOut(){
        if(HmsGmsUtil.isOnlyHms(LetsChatActivity.context)){
            AuthUtil.huaweiAuthInstance.signOut()
        } else {
