package com.mrspd.letschats.fragments.fbLoginFragment
...
import com.mrspd.letschats.databinding.FacebookLoginFragmentBinding
import com.mrspd.letschats.ui.mainActivity.SharedViewModel
import com.mrspd.letschats.util.AuthUtil
import com.mrspd.letschats.util.ErrorMessage
import com.mrspd.letschats.util.eventbus_events.CallbackManagerEvent
...
class FacebookLoginFragment : Fragment() {
    ...
    private fun navigateToHome() {
        ...
        try {
            if (parentFragment?.javaClass.toString() == "class com.mrspd.letschats.fragments.login.LoginFragment") {

                this@FacebookLoginFragment.findNavController()
                    .navigate(R.id.action_loginFragment_to_homeFragment)
            } else if (parentFragment?.javaClass.toString() == "class com.mrspd.letschats.fragments.register.SignupFragment") {
                this@FacebookLoginFragment.findNavController()
